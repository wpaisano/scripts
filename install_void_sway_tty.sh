...
# Objetivo: pós-instalação com Sway e pacotes complementares + início automático no TTY1
...
echo "[Extra] Configurando início automático do Sway no TTY1..."
if ! grep -q 'exec sway' ~/.bash_profile 2>/dev/null; then
cat << 'EOF' >> ~/.bash_profile

# Início automático do Sway no TTY1
...
echo "O Sway iniciará automaticamente ao logar no TTY1."
echo "======================================================="